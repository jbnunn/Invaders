...
The book is poorly edited, and many parts can be confusing because the code often isn't fully explained. Also, the original intent of the code was to fit in a 512KB boot sector. Because of that, the author has many tricks and optimizations that can make following the code difficult for a beginner. 
